...
public class change_smoke : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        _changeSmoke(ps3, loudness); _changeSizeSmoke2(ps3, loudness);
        _changeSmoke(ps4, loudness); _changeSizeSmoke2(ps4, loudness);
        _changeSmoke(ps5, loudness); _changeSizeSmoke2(ps5, loudness);

        _changeSmoke(ps6, loudness); _changeSizeSmoke3(ps6, loudness);
        _changeSmoke(ps7, loudness); _changeSizeSmoke3(ps7, loudness);
        _changeSmoke(ps8, loudness); _changeSizeSmoke3(ps8, loudness);
    ...
    void _changeSizeSmoke(ParticleSystem pSystem, float loud)
    {
        ...
        randA = Random.Range(0.4f, 0.6f);
        randB = Random.Range(0.2f, 0.5f);
        randC = Random.Range(0.3f, 0.5f);
        ...
        {                                               //värdena får Louise sätta
            curve = new AnimationCurve(new Keyframe[] { new Keyframe(0f, Mathf.Lerp(used_smoke[0].value, randA+1.2f, lerpValue)),
                                                        new Keyframe(0.5f, Mathf.Lerp(used_smoke[1].value, randB+1.2f, lerpValue)),
                                                        new Keyframe(1f, Mathf.Lerp(used_smoke[2].value, randC+1.2f, lerpValue))});
            used_smoke = curve;
        }
        else
        {                                               //värdena får Louise sätta
            curve = new AnimationCurve(new Keyframe[] { new Keyframe(0f, Mathf.Lerp(used_smoke[0].value, randA+0.2f, lerpValue)),
                                                        new Keyframe(0.5f, Mathf.Lerp(used_smoke[1].value, randB+0.2f, lerpValue)),
                                                        new Keyframe(1f, Mathf.Lerp(used_smoke[2].value, randC+0.2f, lerpValue))});
            used_smoke = curve;
        }
