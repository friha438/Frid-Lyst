...
public class changeColor : MonoBehaviour
{
    ...
    { 
        ...
        _changeColor(ps3, loudness);    _changeSize2(ps3, loudness);
        _changeColor(ps4, loudness);    _changeSize2(ps4, loudness);
        _changeColor(ps5, loudness); _changeSize2(ps5, loudness);

        _changeColor(ps6, loudness); _changeSize3(ps6, loudness);
        _changeColor(ps7, loudness); _changeSize3(ps7, loudness);
        _changeColor(ps8, loudness); _changeSize3(ps8, loudness);
    ...
    void _changeSize(ParticleSystem pSystem, float loud)
    {
        ...
        if (loud > 0.5)
        {
            ...
            curve = new AnimationCurve(new Keyframe[] { new Keyframe(0f, Mathf.Lerp(used[0].value, randA+1, lerpValue)),
                                                        new Keyframe(0.5f, Mathf.Lerp(used[1].value, randB+1, lerpValue)),
                                                        new Keyframe(1f, Mathf.Lerp(used[2].value, randC+1, lerpValue))});
            used = curve; 
         }
         else
         {
