...
_a ("Speed", Range(0, 10)) = 0.1
_b ("Warp", Range(0, 20)) = 0.1
_size("siize", Range(0, 20)) = 0.1
_c ("Size", Range(0, 1.5)) = 0.1
_d ("Intensity", Range(0, 7)) = 0.1
_h ("star", Range(0, 1)) = 0.1
...
return frac(sin(dot(st.xy,float2(12.9898,78.233)))* 43758.5453123*n);
}
...
float2 r = float2(0,0);
r.x = fbm( st + 1.0*q + float2(1.7,9.2)*_Time.y*_a+ 0.15,1)*_b;
r.y = fbm( st + 1.0*q + float2(8.3,2.8)*_Time.y*_a+ 0.126,1)*_b;
